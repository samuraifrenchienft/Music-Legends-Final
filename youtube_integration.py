...
=======
                    # FILTER OUT only obvious VEVO and topic channels
                    if ('vevo' in channel or
                        'topic' in channel or
                        'official audio' in title):
                        print(f"🚫 Filtering out VEVO/topic content: {snippet['title']}")
>>>>>>> 4094ff259d95372729a7607ed2209da1950bc904
                        continue
